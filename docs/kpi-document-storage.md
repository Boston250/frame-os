...
The application accepts PDFs only, up to 15 MB each. Database records store the document title, original filename, uploader, upload time, and the secured file reference.
