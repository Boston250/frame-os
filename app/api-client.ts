...
export const frameApi={
  ...
  simpleWorkspace:()=>request<{profile:{employeeId:string;employeeNumber:string;name:string;department:string;kind:string;roles:string[]};menu:string[]}>("/api/simple-workspace"),
  simpleReports:()=>request<{data:Record<string,unknown>[]}>("/api/simple-reports"),
  createSimpleReport:(input:Record<string,unknown>)=>request<{data:Record<string,unknown>}>("/api/simple-reports",{method:"POST",body:JSON.stringify(input)}),
  simpleFollowups:()=>request<{data:Record<string,unknown>[]}>("/api/simple-followups"),
  createSimpleFollowup:(input:Record<string,unknown>)=>request<{data:Record<string,unknown>}>("/api/simple-followups",{method:"POST",body:JSON.stringify(input)}),
  simpleBudgets:()=>request<{data:Record<string,unknown>[]}>("/api/simple-budgets"),
  createSimpleBudget:(input:Record<string,unknown>)=>request<{data:Record<string,unknown>}>("/api/simple-budgets",{method:"POST",body:JSON.stringify(input)}),
  decideSimpleBudget:(id:string,input:Record<string,unknown>)=>request<{data:Record<string,unknown>}>(`/api/simple-budgets/${id}/decision`,{method:"POST",body:JSON.stringify(input)}),
  simpleLeaves:()=>request<{data:Record<string,unknown>[]}>("/api/simple-leaves"),
  createSimpleLeave:(input:Record<string,unknown>)=>request<{data:Record<string,unknown>}>("/api/simple-leaves",{method:"POST",body:JSON.stringify(input)}),
  decideSimpleLeave:(id:string,input:Record<string,unknown>)=>request<{data:Record<string,unknown>}>(`/api/simple-leaves/${id}/decision`,{method:"POST",body:JSON.stringify(input)}),
  simpleTasks:()=>request<{data:Record<string,unknown>[]}>("/api/simple-tasks"),
  ...
  simpleAssets:()=>request<{data:Record<string,unknown>[]}>("/api/simple-assets"),
